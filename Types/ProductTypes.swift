...
public struct ProductOption: Codable, Hashable, Identifiable, Sendable {
    ...
    public init(id: String, code: String, name: String, groupId: String, group: ProductOptionGroup,
                translations: [ProductOptionTranslation] = [], customFields: String? = nil) {
        self.id = id
        self.code = code
        self.name = name
...
public struct ProductOptionGroup: Codable, Hashable, Identifiable, Sendable {
    ...
    public init(id: String, code: String, name: String, options: [ProductOption] = [],
                translations: [ProductOptionGroupTranslation] = [], customFields: String? = nil,
                languageCode: LanguageCode, createdAt: Date, updatedAt: Date) {
        self.id = id
        self.code = code
        self.name = name
...
/// Represents a Vendure collection (renamed to avoid Swift stdlib Collection collision)
public final class VendureCollection: Codable, Hashable, Identifiable, @unchecked Sendable {
    public let id: String
    public let name: String
    public let slug: String
    public let description: String
    ...
    public let parent: VendureCollection?
    public let parentId: String?
    public let children: [VendureCollection]?
    public let featuredAsset: Asset?
    public let assets: [Asset]
    ...
    public init(id: String, name: String, slug: String, description: String,
                ...
                parent: VendureCollection? = nil, parentId: String? = nil, children: [VendureCollection]? = nil,
                ...
                customFields: String? = nil, languageCode: LanguageCode,
    ...
    public static func == (lhs: VendureCollection, rhs: VendureCollection) -> Bool {
...
public struct Facet: Codable, Hashable, Identifiable, Sendable {
    ...
    public init(id: String, name: String, code: String, isPrivate: Bool, values: [FacetValue] = [],
                translations: [FacetTranslation] = [], customFields: String? = nil,
                languageCode: LanguageCode, createdAt: Date, updatedAt: Date) {
        self.id = id
        self.name = name
        self.code = code
...
public struct FacetValue: Codable, Hashable, Identifiable, Sendable {
    ...
    public init(id: String, name: String, code: String, facet: Facet, facetId: String,
                translations: [FacetValueTranslation] = [], customFields: String? = nil,
                createdAt: Date, updatedAt: Date) {
        self.id = id
        self.name = name
        self.code = code
